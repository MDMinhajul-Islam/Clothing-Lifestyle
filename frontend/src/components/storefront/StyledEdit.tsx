...
interface StyledEditProps { products: Product[]; onSelectProduct: (product: Product) => void; onAskVoice: (prompt: string, product?: Product) => void }
