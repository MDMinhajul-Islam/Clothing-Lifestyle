...
from local_product_parser import parse_page_evidence_locally
from page_source_collector import capture_product_page_source

PRODUCT_DETAILS_RAW = RAW / 'product_details'
EDGE_PATH = r"C:\Program Files (x86)\Microsoft\Edge\Application\msedge.exe"
PARSER_VERSION = "phase_1c_v1.0"
PARSER_VERSION = "phase_1c_v2.0_3layer"
...
def extract_page_evidence(page, url):
    """Layer 2 & 3 integration: capture rendered HTML once and parse locally."""
    source_bundle = capture_product_page_source(page, url)
